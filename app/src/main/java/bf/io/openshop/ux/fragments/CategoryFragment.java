...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (startBundle != null) {
            ...
            userAttributes.put("last_visited_category", categoryName);
            userAttributes.put("last_visited_category_id", categoryId);
            Insider.Instance.setUserAttributes(userAttributes);
